...
class NN {
    ...
    add(obj) {
        ...
        if (obj instanceof Layer) {
            ...
            if (__classPrivateFieldGet(this, _NN_layers, "f").length > 0) {
                const prevOutputSize = (_a = __classPrivateFieldGet(this, _NN_layers, "f")[__classPrivateFieldGet(this, _NN_layers, "f").length - 1]) === null || _a === void 0 ? void 0 : _a.shape[1];
    ...
    load(filePath) {
        try {
            ...
            let tempLayer, tempActivationFunction, tempActivationFunctionName, activationFuntionParams;
