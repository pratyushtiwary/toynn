...
exports.cache = {
    ...
    save: (name, content) => {
        ...
        if (entry) {
            // update entry
            const loc = path_1.default.join(cachePath, entry.name);
            ...
            const newFilePath = path_1.default.join(cachePath, newFileName);
    ...
    load: (name) => {
        ...
        exports.cache.clean();
        const registry = exports.cache.loadRegistry();
        const cachePath = globalThis.__cache_path;
