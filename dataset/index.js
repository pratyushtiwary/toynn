...
var _Dataset_length,
  _Dataset_data,
  _DatasetSlice_arrangement,
  _DatasetSlice_dataset;
    ...
    return __awaiter(
      ...
      function* (
        ...
        if (!isURL) {
          ...
          try {
            for (
              var _d = true, file_1 = __asyncValues(file), file_1_1;
              (file_1_1 = yield file_1.next()), (_a = file_1_1.done), !_a;
              _d = true
            ) {
              _c = file_1_1.value;
              _d = false;
...
class DatasetSlice {
  ...
  get(index) {
    return this.onGet(
      __classPrivateFieldGet(this, _DatasetSlice_dataset, "f").get(
        __classPrivateFieldGet(this, _DatasetSlice_arrangement, "f")[index],
      ),
    );
  }
  slice(...selection) {
...
(_DatasetSlice_arrangement = new WeakMap()),
  (_DatasetSlice_dataset = new WeakMap());
exports.default = {
  Dataset,
  DatasetSlice,
};
